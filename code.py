...
#===| User Config |==================================================
SNOWGLOBE_NAME = "KALLIROSCOPE" # name that will show up on smart device
DEFAULT_ANIMATION = 3        # 0-3, index in ANIMATIONS list
DEFAULT_DURATION = 5         # total seconds to play animation
DEFAULT_SPEED = 0.2          # delay in seconds between updates
DEFAULT_COLOR = 0xFFFFFF     # hex color value
...
ANIMATIONS = ('spin', 'pulse', 'strobe', 'lightning')
#===| User Config |==================================================
